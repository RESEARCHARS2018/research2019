                ...
                <div class="ibox-content">
                    <div class="row" style="margin-bottom: 10px">
                        <div class="col-md-4 col-sm-4">
                            <a href="#adduser" rel="modal:open" class="btn btn-info"><i class="fa fa-plus"></i> Add user</a>
                        </div><!-- /.col-md-6 -->
                        ...
                        <div class="table-responsive table-responsive-secondary">
                            <table class="table table-striped table-hover">
                                ...
                                <tr>
                                    ...
                                    <th><a href="#" class="m-r-xs pj-table-sort-up text-muted">
                                            <i class="fa fa-sort-amount-asc"></i></a>Account locked</th>
                                ...
                                <tr data-id="id_1">
                                    ...
                                    <td class="pj-table-cell-editable">
                                            <span class="pj-table-cell-label">Administrator
                                            </span>
                                    ...
                                    <td class="pj-table-cell-editable">
                                            <span class="pj-table-cell-label">
                                            <div role="button" tabindex="0" aria-disabled="false" class="btn btn-primary btn-sm no-margins">
                                            <i class="fa fa-check">
                                            </i>
                                            No
                                            </div>
                                            </span>
                                        <input type="hidden" data-name="locked" class="pj-selector-editable" value="T">
                                    </td>
                                    <td>
                                ...
                                <tr data-id="id_1">
                                    ...
                                    <td class="pj-table-cell-editable">
                                            <span class="pj-table-cell-label">Md.al-amin
                                            </span>
                                        <input type="text" data-name="name" class="form-control pj-selector-editable" value="Administrator" style="display: none;">
                                    </td>
                                    <td class="pj-table-cell-editable">
